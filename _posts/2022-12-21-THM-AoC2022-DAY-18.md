...
To get the information required to close the day, it is request to create three sigma rules based on attack chain report data. One of them is the above, other two are next:
